##
## plot segregation of each chromosome, stacked plots
##
...
plot(seg.both$position[seg.both$contig=="1"], seg.both$Bcount[seg.both$contig=="1"]-seg.both$Acount[seg.both$contig=="1"], ylab="Chr1", pch=19, xlim=xlim, xaxt='n', ylim=c(-30,30))
